...
static const uint8_t spp_data_notify_val[20] = {0x01};
static const uint8_t spp_data_notify_ccc[2] = {0x02, 0x03};

/// SPP Service - command characteristic, read&write without response
static const uint16_t spp_command_uuid = ESP_GATT_UUID_SPP_COMMAND_RECEIVE;
static const uint8_t spp_command_val[10] = {0x04};

/// SPP Service - status characteristic, notify&read
static const uint16_t spp_status_uuid = ESP_GATT_UUID_SPP_COMMAND_NOTIFY;
static const uint8_t spp_status_val[10] = {0x05};
static const uint8_t spp_status_ccc[2] = {0x06, 0x07};
...
static void gatts_profile_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    ...
    case ESP_GATTS_READ_EVT:
        ...
        if (res == SPP_IDX_SPP_STATUS_VAL)
        {
            ...
            ESP_LOGI(GATTS_TABLE_TAG, "Thing: %d", res);
            uint8_t indicate_value[] = {0x01, 0x02, 0x03, 0x04}; // Example value
            uint16_t value_len = sizeof(indicate_value);
            esp_ble_gatts_send_indicate(gatts_if, p_data->read.conn_id, res, value_len, indicate_value, false);
        }
        break;
    ...
    case ESP_GATTS_CONNECT_EVT:
        ...
        ESP_LOGI(GATTS_TABLE_TAG, "stuff: %d", p_data->connect.conn_id);
